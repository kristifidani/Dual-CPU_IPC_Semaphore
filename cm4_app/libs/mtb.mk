...
SEARCH_retarget-io=../../mtb_shared/retarget-io/release-v1.2.0
SEARCH_core-lib=../../mtb_shared/core-lib/release-v1.2.0
SEARCH_core-make=../../mtb_shared/core-make/release-v1.8.0
SEARCH_mtb-hal-cat1=../../mtb_shared/mtb-hal-cat1/release-v1.6.0
SEARCH_mtb-pdl-cat1=../../mtb_shared/mtb-pdl-cat1/release-v2.2.0
SEARCH_psoc6cm0p=../../mtb_shared/psoc6cm0p/release-v2.1.2
SEARCH_recipe-make-cat1a=../../mtb_shared/recipe-make-cat1a/release-v1.8.0
